...
class EmailChangeStrategy implements EmailInterface
{
    #[Inject]
    ...
    {
        // 组装队列数据
        $queue_data = ['email' => $email, 'subject' => 'Verify Your New Email Address', 'template' => $this->template($data)];
        // 获取发送邮件生产者
          ...
          <tr>
            <td style="padding:30px 20px;">
              ...
              <p style="font-size:15px; line-height:1.6; color:#555555; margin:0 0 20px 0;">
                We received a request to change the email address associated with your Verifyworker account.
              ...
              <p style="font-size:14px; color:#777777; margin:0 0 20px 0;">
                ...
                If the link has expired, you can request a new email change verification from our website.
              </p>
              ...
              <p style="font-size:14px; color:#777777; margin:0 0 30px 0;">
                If you did not request an email address change, please ignore this email and your account will remain unchanged.
                If you believe someone else is attempting to access your account, we recommend changing your password immediately.
              </p>
