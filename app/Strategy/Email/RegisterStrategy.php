...
class RegisterStrategy implements EmailInterface
{
    #[Inject]
            ...
            <tr>
                <td style="padding:30px 20px;">
                    ...
                    <p style="font-size:15px; line-height:1.6; color:#555555; margin:0 0 20px 0;">
                        Thank you for registering an account with Verifyworker.
                    </p>
                    ...
                    <p style="font-size:14px; color:#777777; margin:0 0 20px 0;">
                        ...
                        If the link has expired, you can request a new verification email from our website.
                    </p>
                    ...
                    <p style="font-size:14px; color:#777777; margin:0 0 30px 0;">
                        If you did not create an account with Verifyworker, please ignore this email.
