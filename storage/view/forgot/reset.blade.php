...
@section('content')
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-2/5 bg-linear-to-br from-cyan-500 to-cyan-600 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center w-full max-w-lg mx-auto px-10 py-16 text-white">
                <!-- Logo & Brand -->
                <div class="mb-14">
                    <h1 class="text-5xl font-medium mb-5">Reset Password</h1>
        ...
        <div class="w-full lg:w-3/5 flex items-center justify-center px-4 py-12 bg-white" id="app">
            <div class="w-full max-w-md">
                ...
                <div class="mb-8 text-center">
                    <h1 class="text-3xl font-medium text-gray-900">Reset Your Password</h1>
                ...
                <!-- Form Card -->
                <form action="/auth/forgot/reset" method="post" class="space-y-6">
                    <!-- Password -->
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" placeholder="Enter your password" value="{{ $old['password'] ?? '' }}" required class="w-full pl-10 pr-4 py-4 bg-white border border-gray-200 rounded-lg text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all sm:text-sm">
                        </div>
                    </div>

                    <!-- Confirm Password -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2" for="password">Confirm Password</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                                    <g fill="none" stroke="#9ca3af" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                            ...
                            <input type="password" name="password_confirmation" placeholder="Confirm your password" value="{{ $old['password_confirmation'] ?? '' }}" required class="w-full pl-10 pr-4 py-4 bg-white border border-gray-200 rounded-lg text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all sm:text-sm">
                        </div>
                    </div>
    ...
    <!-- Back Button -->
    <a class="fixed top-6 left-6 z-50 flex items-center justify-center w-12 h-12 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-full hover:bg-gray-50 hover:scale-105 transition-all shadow-sm" href="/auth/forgot">
